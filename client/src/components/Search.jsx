...
const Search = () => {
  ...
  return (
    ...
    text-neutral-700 bg-white group '>
        <div>
            {
                (isMobile && isSearchPage ) ? (
                    <Link to={"/"} className='flex justify-center items-center h-full p-3 group-focus-within:text-green-500'>
                        <FaArrowLeft size={20}/>
                    </Link>
                ) :(
        ...
        <div className='w-full h-full'>
            {
                !isSearchPage ? (
                    ...
                    <div className='w-full h-full'>
                        <input
                            type='text'
                            placeholder='Search for Atta, Dal and many more.'
                            autoFocus
