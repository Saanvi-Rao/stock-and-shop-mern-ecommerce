  ...
  return (
    <section className=''>
        <div className='relative bg-white shadow-md p-3 mb-5 flex items-center justify-center'>
            <h2 className='text-center text-2xl font-semibold text-green-800 uppercase tracking-widest'>Upload Product</h2>
        </div>
        <div className='grid p-3'>
            <form className='grid gap-4' onSubmit={handleSubmit}>
                ...
                <div>
                    <p className='font-semibold text-neutral-800'>Image</p>
                    <div>
                ...
                <div className='grid gap-1'>
                  <label htmlFor='unit' className='font-semibold text-neutral-800'>Unit</label>
                  <input 
                    id='unit'
                    type='text'
                ...
                <div className='grid gap-1'>
                  <label htmlFor='stock' className='font-semibold text-neutral-800'>Number of Stock</label>
                  <input 
                    id='stock'
                    type='number'
                ...
                <div className='grid gap-1'>
                  <label htmlFor='price' className='font-semibold text-neutral-800'>Price</label>
                  <input 
                    id='price'
                    type='number'
                ...
                <div className='grid gap-1'>
                  <label htmlFor='discount' className='font-semibold text-neutral-800'>Discount</label>
                  <input 
                    id='discount'
                    type='number'
                ...
                <div onClick={()=>setOpenAddField(true)} className=' border border-green-600 text-green-800 hover:text-white hover:bg-green-700 py-1 px-3 w-32 text-center font-semibold  cursor-pointer rounded'>
                  Add Fields
                </div>
